...
# ╔═╡ 25772fac-f273-4f44-bdd4-0d7eb8a5d301
md"""
You can hide the raw code for markdown cells by clicking on the eye to the left
"""

# ╔═╡ 69456ca5-a789-4085-9f2f-1dc01d5de8d2
md"""
# Example gen function and visualization
"""

# ╔═╡ 7ade7413-b54b-43b4-aa15-5d79c269eab8
@gen function coin(w = 0.5)
	flip ~ bernoulli(w)
	return flip
end

# ╔═╡ afb8c11b-f090-4ee2-a36f-3b5cfc5fd1d4
samples = map(x -> coin(), 1:1000)

# ╔═╡ 2450b21f-841a-4df1-a09c-306599899c64
md"""
check out this plot
"""

# ╔═╡ ac37f76c-7c76-41e0-bf4f-0bbe18064446
histogram(samples)
...
manifest_format = "2.0"
project_hash = "a4d35d1a93024ae2c26c1361c538330961fef768"
